...
def sendhelp():
    ...
    Have a dessert to recommend? Type 'SuggestDessert'
...
def reply(choice):
    ...
    recc1 = ["Can I interest you in {0} food?",
    ...
    recc2 = ["Can I interest you in {0}?",
            "Would you like to have {0}?",
            "How does {0} sound?",
            "Have you had {0}?"]

    responses = [newfood, known, recc1, noclue, noexist, newdish, recc2]
...
async def on_message(message):
    ...
    if 'WTFReset' in message.content:
        remessage = "Clearing past inputs..."
        await message.channel.send(remessage)

        sys.exit(os.system("WTFood.py"))
